          ...
          <div className="px-6 py-5">
            ...
            <table className="w-full text-sm mb-5">
              <tbody>
                ...
                <tr className="border-b border-gray-100"><td className="py-2 pr-4 text-gray-500 font-semibold">University</td><td className="py-2 text-gray-900">{payment.university || "-"}</td></tr>
                ...
                <tr><td className="py-2 pr-4 text-gray-500 font-semibold">Course</td><td className="py-2 text-gray-900">{cleanCourseName(payment.course || payment.program)}{payment.stream ? `-${payment.stream}` : ""}</td></tr>
              </tbody>
            </table>
