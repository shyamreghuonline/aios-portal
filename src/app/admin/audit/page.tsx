  ...
  return (
    <div className="flex-1 flex flex-col gap-4 overflow-hidden">
      ...
      <div className="flex items-center gap-2 flex-wrap text-xs">
        ...
        <span className="text-[11px] font-semibold text-slate-500">Revenue period:</span>
        ...
        {period === "custom" && (
          <>
            <input
              ...
              className="px-2 py-1 text-[11px] rounded border border-slate-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 outline-none"
            />
                ...
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2 min-w-0">
                    ...
                    <div className="min-w-0">
                      <p className="text-xs font-bold text-slate-900 truncate">{c.center}</p>
                            ...
                            <div key={courseKey}>
                              ...
                              >
                                ...
                                <div className="flex items-center gap-4 flex-shrink-0">
                                  ...
                                  <span className="inline-flex items-center justify-center min-w-[32px] px-2 py-0.5 rounded-full text-[11px] font-bold text-amber-800 bg-amber-100">
                                    {list.length}
                                  </span>
                                </div>
                              </button>
